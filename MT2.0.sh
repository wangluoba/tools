...
url="http://misstar.szwyll.com/tools/appstore/$model"
...
if [ $? -eq 0 ];then
    ...
    counter=`curl "http://misstar.szwyll.com/tools/counter.php?sha1sum=$snmd5" -s | awk -F "\"" '{print $4}'`
